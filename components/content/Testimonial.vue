  ...
  <div class="pt-8 sm:inline-block sm:w-full sm:px-4">
    <figure class="rounded-2xl bg-zinc-50 dark:bg-zinc-800/5 p-6 text-sm leading-6 dark:border dark:border-zinc-800/50">
      ...
      <figcaption class="mt-6 flex items-center gap-x-4">
        <NuxtImg class="h-10 w-10 rounded-full bg-zinc-50 dark:bg-zinc-800" :src="image?.src ? image.src : '/img/placeholder.jpg'" :alt="image?.alt ? image.alt : 'Placeholder'" :width="image?.width ? image.width : 80" :height="image?.height ? image.height : 80" />
